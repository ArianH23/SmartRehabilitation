...
df = df.drop('col9', axis=1)

# le = preprocessing.LabelEncoder()
# le.fit(['none', 'power', 'precision'])
if normalize:
    df['col1'] = df['col1']/1920
    df['col2'] = df['col2']/1080
    df['col3'] = df['col3']/1920
    df['col4'] = df['col4']/1080
    df['col5'] = df['col5']/1920
    df['col6'] = df['col6']/1080
    df['col7'] = df['col7']/1920
    df['col8'] = df['col8']/1080
