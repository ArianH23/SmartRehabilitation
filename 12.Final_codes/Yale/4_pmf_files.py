...
df = pd.read_csv('yale_mp_yolo_mp.csv')
...
def apply_pfm(row):
    ...
    pfm = row['picture_name'][16:-4] + '-dpt_beit_large_512.pfm'
    ...
    if h_x1 == 640: h_x1= h_x1-1
    if h_y1 == 480: h_y1= h_y1-1
    if h_x2 == 640: h_x2= h_x2-1
    if h_y2 == 480: h_y2= h_y2-1

    if o_x1 == 640: o_x1= o_x1-1
    if o_y1 == 480: o_y1= o_y1-1
    if o_x2 == 640: o_x2= o_x2-1
    if o_y2 == 480: o_y2= o_y2-1
...
df.to_csv('yale_results.csv',index=False)
